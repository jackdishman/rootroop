...
<template>
	<Head>
		...
		<meta property="og:title" content="Roo Troop - Partners" />
		<meta
		...
		<div class="mb-10">
			...
			<div class="flex flex-col md:flex-row px-24 md:px-32 mb-10">
				...
				<div class="md:ml-16">
					...
					<ul class="list-disc list-inside mt-2">
						<li>Roo Troop holders have an exclusive role when verifying through Collab.Land in the GAC Discord</li>
						<li>
							Roo Troop holders will have the ability to play within GAC's realm to earn $ROOLAH and GAC XP directly
							through the P2E opportunities
						</li>
						<li>
							Roo Troop holders will have access to specific tournaments and streams hosted by GAC where they can earn
			...
			<div class="flex flex-col md:flex-row px-24 md:px-32 mb-10">
				...
				<div class="md:ml-16">
					...
					<p class="mt-5">Roo Troop will receive the following:</p>
					<ul class="list-disc list-inside mt-2">
						<li>Logo rebrand</li>
						<li>Collab IRL events</li>
						<li>Joint marketing efforts</li>
						<li>Marketing and graphic consulting</li>
						<li>Marketing and graphic promotions</li>
						<li>Promotional materials across all mediums</li>
						<li>Inclusion of Roos in physical mediums as they are developed</li>
			...
			<div class="flex flex-col md:flex-row px-24 md:px-32 mb-10">
				...
				<div class="md:ml-16">
					...
					<ul class="list-disc list-inside mt-2">
						<li>BearX will build out a Roo Troop section in Bear World</li>
						<li>BearX will assist in the design for Roo Troop land + VX models</li>
						<li>BearX will bring in a talented network of developers to help fill bounties</li>
			...
			<div class="flex flex-col md:flex-row px-24 md:px-32 mb-10">
				...
				<div class="md:ml-16">
					...
					<ul class="list-disc list-inside mt-2">
						<li>
							Roo Troop & Joey Mob holders can now see Degen Pass alpha calls directly within the Roo Troop server
						</li>
						<li>
							Roo Troop & Joey Mob holders can now see the Fomo Bot, which is a first-of-its-kind bot developed to give
							traders an edge
						</li>
					</ul>
					<p class="mt-10 text-center md:text-left">
			...
			<div class="flex flex-col md:flex-row px-24 md:px-32 mb-10">
				...
				<div class="md:ml-16">
					...
					<ul class="list-disc list-inside mt-2">
						<li>
							Roo Troop & Joey Mob holders can now see Alpha X's alpha & upcoming calls directly within the Roo Troop
							server
						</li>
						<li>
							Roo Troop & Joey Mob holders can now see the Fomo Bot, which is a first-of-its-kind bot developed to give
			...
			<div class="flex flex-col md:flex-row px-24 md:px-32 mb-10">
				...
				<div class="md:ml-16">
					...
					<p class="pt-5">
						...
						you how to fish, not to tell you which fish to mint.
					</p>
					<ul class="list-disc list-inside mt-2">
