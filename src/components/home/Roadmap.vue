<template>
	<div class="bg-rooBlack text-white py-5 w-full flex flex-col justify-center">
		<h2 class="text-3xl font-semibold text-center w-full py-5 uppercase italic">Roadmap</h2>
		<div
			class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-5 w-full px-12 lg:px-24"
		>
			<!-- Stage 1 -->
			...
			<div class="border rounded-lg border-rooRed m-4 p-2">
				...
				<ul class="list-disc list-list-outside pl-5">
					...
					<li class="text-rooRed text-sm">Brand Deals</li>
				</ul>
			</div>
			<!-- Stage 4 -->
			<div class="border rounded-lg border-rooRed m-4 p-2">
				...
				<ul class="list-disc list-outside pl-5">
					...
					<li class="text-white text-sm mb-2">$ROOLAH Shop Expansion</li>
